        ...
        <div className="container px-4 py-5 mx-auto md:px-6 lg:px-10">
            <div className="relative flex items-center justify-between">
                ...
                <div className="lg:hidden">
                    ...
                    >
                        <svg className="w-5 text-[#176AE5]" viewBox="0 0 24 24">
                            <path
                                fill="currentColor"
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <div>
                                        <button
                                            ...
                                            title="Close Menu"
                                            className="p-2 -mt-2 -mr-2 transition duration-200 rounded hover:bg-[#176AE5] focus:bg-gray-200 focus:outline-none focus:shadow-outline"
