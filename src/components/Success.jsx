    ...
    return (
        <div className='mt-20'>
            ...
            <div className='flex gap-4 flex-wrap justify-center items-center mt-6'>
                <div className='py-8 space-y-3 pl-8 px-24 bg-white rounded-lg hover:shadow-lg duration-700 transform shadow hover:-translate-y-2'>
                    <img src={successDoc} className='w-16 h-14 object-cover' alt="" />
                ...
                <div className='py-8 space-y-3 pl-8 px-24 bg-white rounded-lg hover:shadow-lg duration-700 transform shadow hover:-translate-y-2'>
                    <img src={successRev} className='w-16 h-14 object-cover' alt="" />
                ...
                <div className='py-8 space-y-3 pl-8 px-24 bg-white rounded-lg hover:shadow-lg duration-700 transform shadow hover:-translate-y-2'>
                    <img src={successPatients} className='w-16 h-14 object-cover' alt="" />
                ...
                <div className='py-8 space-y-3 pl-8 px-24 bg-white rounded-lg hover:shadow-lg duration-700 transform shadow hover:-translate-y-2'>
                    <img src={successStaffs} className='w-16 h-14 object-cover' alt="" />
