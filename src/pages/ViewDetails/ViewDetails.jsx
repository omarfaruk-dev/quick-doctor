    ...
    return (
        <div className='mb-12 mt-2 space-y-6'>
            <div className='space-y-5'>
                {/* Lawyer profile top */}
                <div className='text-center space-y-4 bg-white p-8 md:p-16 rounded-2xl'>
                ...
                <div className='rounded-2xl p-5 md:p-6 flex flex-col md:flex-row items-center gap-4 md:gap-6 shadow hover:shadow-lg duration-700 transform hover:-translate-y-1'>
                    <div>
                        <img className='w-48 h-48 rounded-2xl border-2 border-[#176AE5]' src={image} alt="" />
                    </div>
